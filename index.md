...
- [[Manager/Execution-Log|Execution Log]]
- [[Manager/Today-Commands|Today's Commands]]
- [[log|Activity Log]]
- [[wiki/index|Wiki Index]]

## Projects
- [[Projects/content-engine|Content Engine]] — AI-powered HTML email generator for Groww (side project, 1-2 weeks)
- [[Projects/compass-mcp-skills|Compass MCP Skills]] — Enhance/create domain skills for Compass (primary work, ongoing)
...
| [[Tasks/CE-2-block-library|Block Library (18 blocks)]] | todo | medium | 2026-04-14 |
...
- [[Deliverables/bootstrap-prompt|Claude Code Bootstrap Prompt]] — Ready-to-paste session starter
- [[Deliverables/compass-mcp-product-doc|Compass MCP Product Doc]] — Official 80+ tools overview
- [[Deliverables/analytics-skills-deep-dive|Analytics Skills Deep Dive]] — All 16 skills reference (18 pages)
- [[Deliverables/compass-setup-guide|Compass Setup Guide]] — Proxy, IDE config, troubleshooting
- [[Deliverables/meeting-notes-images|Meeting Notes (Images)]] — Original handwritten pipeline diagrams
...
### Planning Documents
- task_description_v2.md / task_description.md
- project_plan_v2.md / project_plan_v1.md / project_plan.md
- groww_detailed_project_plan.md
